...
// Misc
DEFINE_string(output_centers_file, "", "File location for centers information");
DEFINE_string(output_assignments_folder,"","File location for storing the outputs of assigned centers to the dataset");
