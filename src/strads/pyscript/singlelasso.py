...
machfile=['./singleconf/mach3.vm']
node = [' --nodefile ./singleconf/node3.conf ']                       
link = [' --linkfile ./singleconf/star3.conf ']

singleflag = ['--singlemach true']
...
os.system("mpirun -np 3  "+prog[0]+" "+node[0]+" "+link[0]+" "+" "+schedulers[0]+" "+modelparams[0]+" "+udfile[0]+" "+uformat[0]+" "+umach[0]+" "+ualias[0]+" "+udfile1[0]+" "+uformat1[0]+" "+umach1[0]+" "+ualias1[0]+" "+" "+" "+maxset[0]+" "+bw[0]+" "+schedthrds[0] +" "+pscheme[0]+" "+pscheme1[0]+" "+aggre[0]+" "+aggrepcnt[0]+" "+aggrep1[0]+" "+upfunc[0]+" "+upfunccnt[0]+" "+upfuncp1[0]+" "+upfuncp2[0]+" "+supfunc[0]+" "+supfunccnt[0]+" "+supfuncp1[0]+" "+supfuncp2[0]+" "+udfile3[0]+" "+uformat3[0]+" "+umach3[0]+" "+pscheme3[0]+" "+ualias3[0]+" "+samples[0]+" "+oupfunc[0]+" "+oupfunccnt[0]+" "+oupfuncp1[0]+" "+oupfuncp2[0]+" "+udfile4[0]+" "+uformat4[0]+" "+umach4[0]+" "+pscheme4[0]+" "+ualias4[0]+" "+osupfunc[0]+" "+osupfunccnt[0]+" "+osupfuncp1[0]+" "+" "+iteration[0]+" "+logfreq[0]+" "+beta[0]+" "+corrthreshold[0]+" "+udfile5[0]+" "+uformat5[0]+" "+umach5[0]+" "+pscheme5[0]+" "+ualias5[0]+" "+singleflag[0]+" "+singleflag[0]+logd[0]+" "+logprefix[0]);
